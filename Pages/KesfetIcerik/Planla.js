...
export default function Planla() {
  ...
  const data = [
    {
      ...
      title: 'CİNSELLİK İLE İLGİLİ YANLIŞ BİLİNENLER',
      subtitle: 'UREME',
      ...
      videoModalContent: (
        <View style={{ alignItems:'center', marginTop:40}}>
          ...
          />
          <View>
            <Text style={styles.videotext}>CİNSELLİK İLE İLGİLİ YANLIŞ BİLİNENLER</Text>
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      ...
      <Text style={styles.icerikheader}>UREME</Text>
      {data.map((item, index) => (
